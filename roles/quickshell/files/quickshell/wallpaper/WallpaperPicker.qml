...
Item {
    ...
    readonly property string srcDir: Quickshell.env("HOME") + "/.dotfiles/shell-wallpapers"

    readonly property var transitions: ["grow", "outer", "random", "wipe", "wave", "center", "fade"]
